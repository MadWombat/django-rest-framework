...
* Removed DjangoFilterBackend inline with deprecation policy. Use `django_filters.rest_framework.FilterSet` or `django_filters.rest_framework.DjangoFilterBackend` instead. [#5273][gh5273]
